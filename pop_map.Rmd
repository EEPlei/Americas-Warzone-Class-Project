...
names(comm) = c("AREA","PERIMETER","COMAREA_","COMAREA_ID","AREA_NUMBE","Geog", "AREA_NUM_1","SHAPE_AREA","SHAPE_LEN","geometry")
...
plot(st_geometry(plot_d), col=plot_d$Total.Population)
```
