...
\noindent The crime data used for this project came from the City of Chicago's website. The data contained every reported crime in Chicago from 2001 to the present (\autoref{data}). \hyperref{Ref5}{[5]} In addition to the type of crime reported (battery, assault, etc.), there was information on the location and time of the crime. The data set was reduced to only consider armed robberies, which we define to be robberies committed with a gun or another type of firearm. \newline 

\noindent The information in the data comes from the Citizen Law Enforcement and Analysis and Reporting (CLEAR) system. The iformation is based on what is supplied by the individuals reporting the crimes and thus may not be accurate. In addition, there is a potential for human error when entering the crimes. The data provides block level information to protect the privacy and identity of those involved in crimes.\hyperref{Ref5}{[5]} \newline
